                    ...
                    <form action="proses_edit_profil.php" method="POST">
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            ...
                            <div>
                                ...
                                <input type="text" name="nomor_induk" value="<?= htmlspecialchars($user['nomor_induk']) ?>" readonly style="width:100%; padding: 10px; border-radius: 8px; border: 1px solid #ddd; background: #f9f9f9;">
                            </div>
